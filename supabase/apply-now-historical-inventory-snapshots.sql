-- =============================================================================
-- APPLY THIS ENTIRE SCRIPT in Supabase Dashboard → SQL Editor → New query → Run
-- Creates historical_inventory_snapshots (required for Inventory History + daily sync)
...
-- Verify (should return historical_inventory_snapshots):
-- SELECT table_name FROM information_schema.tables
-- WHERE table_schema = 'public' AND table_name = 'historical_inventory_snapshots';
