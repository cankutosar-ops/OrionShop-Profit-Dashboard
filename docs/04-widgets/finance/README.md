...
Define what widget documentation may live in `04-widgets/finance/`.
...
Widget docs for finance, settlement, fees, and related monetary UI units.

## Documentation rules

1. One file per widget: `WIDGET_<NAME>.md`.
2. Copy `/docs/templates/WIDGET_TEMPLATE.md`.
3. Link financial engine / dashboard modules as Related Modules when known.
