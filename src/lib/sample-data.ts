...
export const SAMPLE_OVERVIEW: OverviewMetrics = {
  ...
  marketplaceFeesPresentation: {
    ...
    ppvzVwNds: 0,
    wbRemuneration: null,
    wbRemunerationPercent: null,
    wbRemunerationStatus: "LEGACY_RAW_UNAVAILABLE",
    salesToSettlementDifference: 328_400,
    attributedMarketplaceFees: 320_000,
    unattributedMarketplaceFees: 8_400,
  ...
  return {
    overview: {
      ...
      marketplaceFeesPresentation: {
        ...
        wbRemuneration: null,
        wbRemunerationPercent: null,
        wbRemunerationStatus: "NO_EVIDENCE",
        salesToSettlementDifference: 0,
